// ====================================================================
// ESP32-C3 FULL CODE - FIXING OLD LOGIC WITH 5 PATTERNS & DUAL SPEED
// ====================================================================
...
// ড্রপডাউন মেমোরি স্টেট (১ থেকে ৫ পর্যন্ত অপশন)
...
// স্বাধীন প্যাটার্ন স্পিড টাইমার ভ্যারিয়েবল (ডিফল্ট 80ms)
...
// ================= APPLY (১০০% অরিজিনাল ওল্ড লজিক ফিক্সড) =================
void applyRelays(){
    ...
    // Relay5 & Relay6 Logic (SHARED PIN 6)
    if(signalActive){
...
void runPattern(){
    ...
    // Only For Back (অ্যারে সাইজ ১১ অনুযায়ী লুপ)
    ...
    // Front & Rear (অ্যারে সাইজ ১০ অনুযায়ী লুপ)
...
/* DROPDOWN BOX WITH INTEGRATED INPUTS */
.dropdown-box {
    margin-bottom: 22px;
    display: flex;
    flex-direction: column;
...
.menu-btn:active {
    ...
    box-shadow: 0 2px 0 #7f1d1d, 0 3px 6px rgba(0,0,0,0.4), inset 0 2px 4px rgba(0,0,0,0.4);
}
.menu-btn.active {
...
.menu-btn.active:active {
    transform: translateY(3px);
    box-shadow: 0 2px 0 #064e3b, 0 3px 6px rgba(0,0,0,0.4), inset 0 2px 4px rgba(0,0,0,0.5);
}
...
.card.middle-yellow { grid-column: 1 / span 2; flex-direction: row; justify-content: space-between; padding: 18px 24px; background: linear-gradient(135deg, rgba(234, 179, 8, 0.08), rgba(15, 23, 42, 0.6)); }
...
.sub-btn { 
    ...
    border-radius: 14px; 
    border: 1px solid rgba(255, 255, 255, 0.1); 
    background: linear-gradient(135deg, #242f47 0%, #111827 100%); 
    color: #94a3b8; 
    font-size: 13px; 
    font-weight: 700; 
    letter-spacing: 0.5px;
...
.config-area input { 
    ...
    padding: 12px 4px; 
    border-radius: 12px; 
    font-size: 12px; text-align: center; outline: none; box-shadow: inset 0 2px 4px rgba(0,0,0,0.5); }
...
<div id="sidePanel" class="side-panel">
    ...
    <div class="dropdown-box">
        <label for="backPatternSelect">Only for Back Pattern</label>
    ...
    <div class="dropdown-box">
        <label for="frPatternSelect">Front and Rear Pattern</label>
...
<div class="container">
    <div class='wrap'>
        ...
        <div class='card panel-red'><h3>Only Back</h3><div id='b2' class='logo off' onclick='tg(2)'><img src='https://raw.githubusercontent.com/pappuroy0482/Helmet-LED-Control/refs/heads/main/Helmet%20LED%20button%20photo/Back%20Led.jpg' alt='Back'></div></div>
        ...
        <div class='card panel-orange'><h3>Back Burst</h3><div id='b4' class='logo off' onclick='tg(4)'><img src='https://raw.githubusercontent.com/pappuroy0482/Helmet-LED-Control/refs/heads/main/Helmet%20LED%20button%20photo/Back%20Burst.jpg' alt='Burst'></div></div>
        
        <div class='card middle-yellow'><h3>Indicator Burst</h3><div id='b5' class='logo off' onclick='tg(5)'><img src='https://raw.githubusercontent.com/pappuroy0482/Helmet-LED-Control/refs/heads/main/Helmet%20LED%20button%20photo/INDICATOR%20BURST.jpg' alt='Indicator'></div></div>
