// ====================================================================
// ESP32-C3 FULL CODE - FIXED LOGIC WITH 5 PATTERNS, DUAL SPEED & BACK LOW BEAM
// ====================================================================
...
bool lowBeamState=false;   // Back Low Beam এর স্টেট ভ্যারিয়েবল
...
void saveState(){
    ...
    EEPROM.write(29, lowBeamState);  // নতুন পিনের স্টেট মেমোরিতে সেভ
    EEPROM.commit();
}
...
void loadState(){
    ...
    lowBeamState=EEPROM.read(29);    // নতুন পিনের স্টেট মেমোরি থেকে রিড
...
void sendStatus(){
    ...
    json+=",\"lb\":"+String(lowBeamState);   // JSON এ নতুন পিন অ্যাড
...
/* নতুন ১০ নম্বর পিনের জন্য ডিজাইন (Back Low Beam) */
...
/* কাস্টম কম্বো বক্স ডিজাইন: Indicator Burst এবং Back Burst একসাথে */
.card.middle-yellow { 
...
void setup(){
    ...
    pinMode(RELAY_LOW_BEAM, OUTPUT); // নতুন পিন ১০ আউটপুট মোড সেটআপ
    ...
    server.on("/toggle7",toggleLowBeam); // নতুন বাটন ক্লিক করলে টগল ফাংশন কল হবে
